...
//  - Deliver daily at [hour]: registers a macOS background job that prints the
...
export default function Delivery({ schedule, onChange, print, onPrint }: Props) {
  ...
  return (
    <div className="delivery">
      <div className="delivery-row" title="Prints a fresh edition in the background every day at this time, so it's ready when you open the app. If the Mac is asleep, it runs when it wakes.">
